...
import com.baidu.mapsdkexample.util.overlayutil.BikingRouteOverlay;
 ...
 * 同时展示如何进行节点浏览并弹出泡泡
 */
public class BikingRoutePlanActivity extends AppCompatActivity
    ...
    public void searchButtonProcess(View v) {
        Utils.hideKeyBoard(BikingRoutePlanActivity.this);
    ...
    public void onGetBikingRouteResult(BikingRouteResult result) {
        if (result != null && result.error == SearchResult.ERRORNO.AMBIGUOUS_ROURE_ADDR) {
            ...
            Toast.makeText(BikingRoutePlanActivity.this,
        ...
        if (result == null || result.error == SearchResult.ERRORNO.RESULT_NOT_FOUND) {
            Toast.makeText(BikingRoutePlanActivity.this, "抱歉，未找到结果", Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.route_detail_button:
                Intent intent = new Intent(BikingRoutePlanActivity.this.getApplicationContext(),
