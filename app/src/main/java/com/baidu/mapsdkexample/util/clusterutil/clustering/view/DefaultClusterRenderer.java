...
package com.baidu.mapsdkexample.util.clusterutil.clustering.view;

import static com.baidu.mapsdkexample.util.clusterutil.MarkerManager.MAX_DISTANCE_AT_ZOOM;
...
import com.baidu.mapsdkexample.util.clusterutil.MarkerManager;
...
import com.baidu.mapsdkexample.util.clusterutil.projection.SphericalMercatorProjection;
import com.baidu.mapsdkexample.util.clusterutil.ui.IconGenerator;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements
    ...
    private com.baidu.mapsdkexample.util.clusterutil.ui.SquareTextView makeSquareTextView(
            Context context) {
        com.baidu.mapsdkexample.util.clusterutil.ui.SquareTextView squareTextView =
                new com.baidu.mapsdkexample.util.clusterutil.ui.SquareTextView(context);
